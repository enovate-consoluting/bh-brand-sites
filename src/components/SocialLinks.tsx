...
import type { ClientSocialLink } from '@/types/database';

interface SocialLinksProps {
  links: ClientSocialLink[];
  textColor?: string;
}
...
export function SocialLinks({ links, textColor }: SocialLinksProps) {
  if (!links.length) return null;

  return (
    <div className="flex items-center gap-4">
      {links.map((link) => {
        const iconPath = platformIcons[link.platform.toLowerCase()];
